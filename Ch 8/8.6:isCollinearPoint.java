 ...
 *a straight line can be drawn that connects them. Two basic examples are three points that have the 
 *same x- or y-coordinate. The more general case can be determined by calculating the slope of the 
 *line between each pair of points and checking whether this slope is the same for all pairs of 
 *points. Use the formula (y2 - y1) / (x2 - x1) to determine the slope between two points 
