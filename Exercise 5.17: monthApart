 ...
 * For example, the following dates are all considered to be at least a month apart from 9/19 
 * 
 * (September 19): 2/14, 7/25, 8/2, 8/19, 10/19, 10/20, and 11/5. 
 * 
 * The following dates are NOT at least a month apart from 9/19: 
 * 
 * 9/20, 9/28, 10/1, 10/15, and 10/18. 
 * 
...
public class Test {
	public static void main(String[] args) {
		boolean x = monthApart(9, 19, 7, 24);
		System.out.print(x);
	}

static boolean monthApart(int month1, int day1, int month2, int day2) {
